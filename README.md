...
- **Yapay zekâ destekli fiyat tahmini:** LSTM / Prophet modeli ile olasılıksal fiyat tahmini
- **Akıllı portföy optimizasyonu:** Kullanıcı risk profiline göre AI alım/satım önerisi
- **Doğal dil sorgulama:** "Geçen ay ne kadar kazandım?" gibi LLM destekli sorgular
- **Otomatik haber özeti:** Piyasayı etkileyen haberleri AI ile özetleyip bildirim olarak iletme

### Çözülebilecek Kullanıcı Problemleri

- Birden fazla altın türünü (gram, ons, cumhuriyet, ata, yarım) ayrı takip edememe
- Yatırım kararlarını veriye değil sezgiye dayalı alma
- Piyasa haberlerini takip etmek için farklı uygulamalar kullanma zorunda kalma

### Ürünün Nasıl Ölçeklenebileceği

- **Backend entegrasyonu:** Node.js / Supabase ile kullanıcı hesapları ve bulut senkronizasyonu
- **Mobil uygulama:** React Native veya Flutter ile iOS/Android'e taşıma
- **Gerçek zamanlı veri:** WebSocket ile canlı altın kuru akışı
...
| JavaScript (Vanilla) | Form doğrulama, localStorage |
